...
<div class="row mt">
          <div class="col-lg-8">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="post" action="editcustomerprofile.jsp">
					 ...
					 <div class="form-group ">
                        ...
                        <div class="col-lg-6">
                        <input class=" form-control" id="fname" name="fname" type="text" value="${fname}" readonly="readonly"/>
                        </div>
                     </div>
					 ...
					 <div class="form-group ">
                        ...
                        <div class="col-lg-6">
                        <input class=" form-control" id="lname" name="lname" type="text" value="${lname}" readonly="readonly" />
                        </div>
                     </div>				
					  <div class="form-group ">
                        <label for="firstname" class="control-label col-lg-2"><b><font size="3px">Email id:</font></b></label>
                        <div class="col-lg-6">
                        <input class=" form-control" id="emailid" name="emailid" type="text" value="${emailid}" readonly="readonly" />
                        </div>
                     </div>				
					 <div class="form-group ">
                        <label for="firstname" class="control-label col-lg-2"><b><font size="3px">Username</font></b></label>
                        <div class="col-lg-6">
                        <input class=" form-control" id="username" name="username" type="text" value="${username}" readonly="readonly"/>
                        </div>
                     </div>					
					 <div class="form-group ">
                        <label for="firstname" class="control-label col-lg-2"><b><font size="3px">Password</font></b></label>
                        <div class="col-lg-6">
                        <input class=" form-control" id="password" name="password" type="text" value="${password}" readonly="readonly" />
                        </div>
                     </div>					
					 <div class="form-group ">
                        <label for="firstname" class="control-label col-lg-2"><b><font size="3px">Address</font></b></label>
                        <div class="col-lg-6">
                        <input class=" form-control" id="address" name="address" type="text" value="${address}" readonly="readonly"/>
                        </div>
                     </div>					
						 <div class="form-group ">
                        <label for="firstname" class="control-label col-lg-2"><b><font size="3px">Mobile number:</font></b></label>
                        <div class="col-lg-6">
                        <input class=" form-control" id="mobileno" name="mobileno" type="text" value="${mobileno}" readonly="readonly"/>
                        </div>
                     </div>								
						 <div class="form-group">
